...
use crate::dcm_xml::{ file_to_xml, parse_dcm_xml, default_dcm_xml };
...
fn main() -> Result<(), std::io::Error> {
    ...
    println!("Dicom XML file path: \n{}", dicom_xml_path.clone().and_then(|p| p.into_os_string().into_string().ok()).unwrap_or("None".to_string()));
