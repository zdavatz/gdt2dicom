...
impl VddsFile {
        ...
        P: Into<PathBuf>,
    {
        ...
        let temp_patient_file = NamedTempFile::new()?;
        let temp_patient_file_path = temp_patient_file.path();
        ini_file.write_to_file(temp_patient_file_path)?;
        Ok(())
    }
}

fn wait_for_ready(path: &PathBuf) {}
